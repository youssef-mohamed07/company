                                ...
                                navigation.map((item, idx) => {
                                    return (
                                        <li key={idx}>
                                            {
                                                item.isDrapdown ? (
                                                    <button className="w-full flex items-center justify-between gap-1 text-black hover:text-gray-600 transition"
                                                    ...
                                                    <a href={item.path} className="block text-black hover:text-gray-600">
                                                        {item.title}
                                                    </a>
                                                )
                                            }
                                                                        ...
                                                                        {dropdownItem.navs.map((navItem, idx) => (
                                                                            <li key={idx} className="group">
                                                                                <a href={navItem.path} className='flex gap-3 items-center'>
                                                                                    <div className='w-12 h-12 rounded-full bg-yellow-500 text-white flex items-center justify-center duration-150 group-hover:bg-yellow-600 group-hover:text-white md:w-14 md:h-14'>
                                                                                        {navItem.icon}
                                                                                    </div>
                                                                                    <div>
                                                                                        <span className="text-black duration-200 group-hover:text-gray-600 transition text-sm font-medium md:text-base">{navItem.title}</span>
