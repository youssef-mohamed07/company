                      ...
                      <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                          <div className="relative">
                              ...
                              <input
                                  ...
                                  className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-indigo-600 shadow-sm "
                              />
                          </div>
                          <button className="block w-auto py-3 px-4 font-medium text-sm text-center transition duration-400 text-yellow-500 bg-black hover:bg-gray-800 active:bg-black active:shadow-none  shadow">
                              Subscribe
                          </button>
                      </form>
                  </div>
