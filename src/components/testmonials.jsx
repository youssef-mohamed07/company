...
<br></br>
        <section className="relative py-14">
            ...
            <div className="absolute top-0 w-full h-[350px]" style={{ background: "linear-gradient(152.92deg, rgba(252, 216, 131, 0.2) 4.54%, rgba(250, 233, 122, 0.17) 34.2%, rgba(249, 252, 131, 0.1) 77.55%)" }}></div>
        </section>
        </>
    )
}