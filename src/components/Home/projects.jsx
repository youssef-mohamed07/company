...
const projects = [
  ...
  { id: 19, name: "Spare Parts", address: '3738 Elm St. Philadelphia, Pennsylvania', image: 'e.avif', category: 'Trade', description: 'Wide variety of spare parts for different vehicle brands.' },
  { id: 20, name: "Vehicle Repair", address: '3940 Oak St. Detroit, Michigan', image: 'e.avif', category: 'Services', description: 'Expert vehicle repair services with guaranteed quality.' },
  { id: 21, name: "Construction", address: '4142 Pine St. Austin, Texas', image: 'e.avif', category: 'Construction', description: 'Reliable construction services with timely project completion.' },
  { id: 22, name: "Publicity", address: '4344 Maple St. Boston, Massachusetts', image: 'e.avif', category: 'Services', description: 'Creative publicity campaigns to enhance brand awareness.' },
  { id: 23, name: "E-commerce", address: '4546 Birch St. Phoenix, Arizona', image: 'e.avif', category: 'Technology', description: 'Innovative e-commerce solutions for seamless online shopping.' },
  { id: 24, name: "Agriculture", address: '4748 Cedar St. Denver, Colorado', image: 'e.avif', category: 'Agriculture', description: 'Sustainable agricultural practices for high yield production.' },
  { id: 25, name: "Tourism", address: '4950 Redwood St. Honolulu, Hawaii', image: 'e.avif', category: 'Hospitality', description: 'Unforgettable tourism experiences with guided tours and activities.' },
  { id: 26, name: "Restaurants", address: '5152 Willow St. Miami, Florida', image: 'e.avif', category: 'Hospitality', description: 'Culinary delights from top-rated restaurants across the region.' },
  { id: 27, name: "Educational Services", address: '5354 Elm St. Portland, Oregon', image: 'e.avif', category: 'Education', description: 'High-quality educational services for all age groups.' },
  { id: 28, name: "Laboratories", address: '5556 Oak St. Chicago, Illinois', image: 'e.avif', category: 'Education', description: 'State-of-the-art laboratories for scientific research and development.' },
  { id: 29, name: "Aircraft Trade", address: '5758 Pine St. Seattle, Washington', image: 'e.avif', category: 'Trade', description: 'Exclusive deals on aircraft and aviation equipment.' },
  { id: 30, name: "Construction", address: '5960 Maple St. Boston, Massachusetts', image: 'e.avif', category: 'Construction', description: 'Comprehensive construction services from planning to execution.' },
  { id: 31, name: "Oil Products", address: '6162 Birch St. Miami, Florida', image: 'e.avif', category: 'Trade', description: 'High-quality oil products for various industries.' },
  { id: 32, name: "Industrial Workshops", address: '6364 Cedar St. Detroit, Michigan', image: 'e.avif', category: 'Manufacturing', description: 'Advanced industrial workshops with modern machinery.' },
  { id: 33, name: "Recycling Plant", address: '6566 Redwood St. Portland, Oregon', image: 'e.avif', category: 'Services', description: 'Innovative recycling solutions for a sustainable future.' },
  { id: 34, name: "Waste Management", address: '6768 Willow St. St. Louis, Missouri', image: 'e.avif', category: 'Services', description: 'Efficient waste management services for urban areas.' },
  { id: 35, name: "Auto Spare Parts", address: '6970 Elm St. Los Angeles, California', image: 'e.avif', category: 'Trade', description: 'Wide selection of auto spare parts for various models.' },
  { id: 36, name: "Vehicle Repair", address: '7172 Oak St. Las Vegas, Nevada', image: 'e.avif', category: 'Services', description: 'Expert vehicle repair and maintenance services.' },
];
